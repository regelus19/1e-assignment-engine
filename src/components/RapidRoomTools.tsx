...
const flags:{value:ComplexityFlag;label:string}[]=[
  {value:'Possible DC',label:'Possible DC'}, {value:'Expected DC',label:'Expected DC'}, {value:'Fresh Post-Op',label:'Fresh Post Op'}, {value:'Pending Surgery',label:'Pending Surgery'}, {value:'Pending Procedure',label:'Pending Procedure'},
