...
const CURRENT_MRS_KEY='1E_CURRENT_MRS_INPUT',PROJECTED_MRS_KEY='1E_PROJECTED_MRS_INPUT',PLAN_DATE_KEY='1E_PLAN_DATE',SHIFT_KEY='1E_SHIFT_TYPE',PLAN_SOURCE_KEY='1E_PLAN_SOURCE_SHIFT';
...
export const App:React.FC=()=>{
 ...
 const reset=()=>{StorageService.resetToDefaults();localStorage.removeItem(PLAN_SOURCE_KEY);setRoster(StorageService.loadStaff());setRooms(StorageService.loadRooms());setOnCall(StorageService.loadOnCall());setForecastEvents(StorageService.loadForecast());setWarnings([]);setCurrentShift(StorageService.loadCurrentShift());setHistory([]);setActiveTab('current')};
