...
export type ComplexityFlag = 'Vent' | 'Pressors' | 'Vasoactive Support' | 'Inotropic Support' | 'Impella/IABP' | 'Fresh Post-Op' | 'Pending Surgery' | 'Pending Procedure' | 'HD/Dialysis' | 'Isolation' | 'Sitter/Safety' | 'High Fall Risk' | 'Confused' | 'Admission' | 'Transfer' | 'Possible DC' | 'Expected DC' | 'BLOCKED' | 'Discharge';
